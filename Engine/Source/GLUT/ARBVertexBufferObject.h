...
bool glIsBufferARB(GLuint buffer);
...
bool glUnmapBufferARB(GLenum target);
...
typedef bool (APIENTRY * PFNGLISBUFFERARBPROC)(GLuint buffer);
...
typedef bool (APIENTRY * PFNGLUNMAPBUFFERARBPROC)(GLenum target);
